...
% Basiert auf KOMA-Scripts scrlttr2, https://www.ctan.org/pkg/scrlttr2?lang=de
...
\documentclass[
    ...
    paper=A4,
    %
    % Mehr Platz am Ende der ersten Seite
...
%\addtoplength[1]{firstfootvpos}{4cm}
...
% Wenn in DIN A3 Briefumschlag, der Empfänger zu weit nach unten rutscht.
% Adresse im Adressfeld oben ausgerichtet.
%\KOMAoptions{addrfield=alignedtop}
